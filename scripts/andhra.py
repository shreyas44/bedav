...
def get_data(driver, city):
  ...
  data = pd.DataFrame(columns=["name", "gen_total", "oxy_total", "ICU_total", "vent_total", "gen_occupied", "oxy_occupied", "ICU_occupied", "vent_occupied", "city"])
  ...
  data[["gen_total", "oxy_total", "ICU_total", "vent_total", "gen_occupied", "oxy_occupied", "ICU_occupied", "vent_occupied"]] = data[["gen_total", "oxy_total", "ICU_total", "vent_total", "gen_occupied", "oxy_occupied", "ICU_occupied", "vent_occupied"]].applymap(lambda value: re.sub(',', '', str(value))).apply(pd.to_numeric, errors="coerce").applymap(lambda value: value if value > 0 else -1 * value)
